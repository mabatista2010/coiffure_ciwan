-- Script para crear y configurar la tabla de roles de usuario en Supabase
...
-- Insertar el usuario existente como admin ANTES de habilitar RLS
...
-- para poder insertar registros independientemente de las políticas RLS
