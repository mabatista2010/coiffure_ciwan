-- Reservas V2.1 - Guard adicional por horario regular de centro
-- Objetivo:
-- 1) Evitar oferta/creación de slots fuera de location_hours.
-- 2) Introducir error_code explícito: outside_location_hours.
...
begin
  ...
  -- Guard estricto por horario regular del centro (location_hours)
  if not exists (
    select 1
